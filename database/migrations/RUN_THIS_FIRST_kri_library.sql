-- ================================================================
-- STEP 1: Create KRI/KCI Library Table
-- Run this FIRST before the appetite migration
-- ================================================================
-- This is extracted from 20251126000004_create_kri_kci_library.sql
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '✅ KRI/KCI Library table created successfully';
  RAISE NOTICE '   You can now run the appetite migration';
  RAISE NOTICE '';
END $$;
