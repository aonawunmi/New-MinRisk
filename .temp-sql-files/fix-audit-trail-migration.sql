-- Fix Audit Trail Migration
-- Run this in Supabase Dashboard: SQL Editor
-- This will diagnose and fix the audit trail table issue
...
-- If table exists, check what columns it has
...
-- =====================================================
-- STEP 2: CLEANUP - Drop partially created table
-- =====================================================

-- Run this to remove any partially created table
DROP TABLE IF EXISTS audit_trail CASCADE;

-- =====================================================
-- STEP 3: CREATE TABLE - Complete definition
-- =====================================================
...
CREATE INDEX idx_audit_trail_entity_code ON audit_trail(entity_code);
CREATE INDEX idx_audit_trail_org_time ON audit_trail(organization_id, performed_at DESC);
...
-- =====================================================
-- STEP 6: MANUAL LOGGING FUNCTION
-- =====================================================
...
-- =====================================================
-- STEP 7: AUTO-LOGGING TRIGGERS (RISKS)
-- =====================================================
...
-- =====================================================
-- STEP 8: AUTO-LOGGING TRIGGERS (CONTROLS)
-- =====================================================
...
-- =====================================================
-- STEP 9: AUTO-LOGGING TRIGGERS (USER PROFILES)
-- =====================================================
...
-- Should return 0
SELECT COUNT(*) as row_count FROM audit_trail;

-- Should return 3 trigger names
SELECT tgname FROM pg_trigger WHERE tgname LIKE 'audit_%';

-- Should return 3 function names
SELECT proname FROM pg_proc
WHERE proname IN ('log_audit_entry', 'audit_risks_trigger', 'audit_controls_trigger', 'audit_user_profiles_trigger');
