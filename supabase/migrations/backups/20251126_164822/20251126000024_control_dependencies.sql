...
WHERE c1.control_code = mapping.control_code
  ...
  AND c1.organization_id = 'YOUR_ORG_ID'
  AND c2.organization_id = 'YOUR_ORG_ID'
...
--   (SELECT id FROM control_library WHERE control_code = 'CTL-018' AND organization_id = 'YOUR_ORG_ID')
-- );

-- Example 3: Find controls ready for implementation (no prerequisites)
-- SELECT * FROM control_implementation_readiness
-- WHERE organization_id = 'YOUR_ORG_ID' AND readiness_status = 'Ready';
