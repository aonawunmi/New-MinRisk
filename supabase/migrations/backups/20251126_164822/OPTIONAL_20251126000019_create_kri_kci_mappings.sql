...
JOIN kri_kci_library kri ON kri.indicator_code = mapping.kri_code AND kri.organization_id = 'YOUR_ORG_ID'
WHERE rc.cause_code = mapping.cause_code AND rc.organization_id = 'YOUR_ORG_ID'
...
JOIN kri_kci_library kci ON kci.indicator_code = mapping.kci_code AND kci.organization_id = 'YOUR_ORG_ID'
WHERE imp.impact_code = mapping.impact_code AND imp.organization_id = 'YOUR_ORG_ID'
