...
-- SELECT * FROM active_breaches_view WHERE organization_id = 'YOUR_ORG_ID' ORDER BY priority, hours_active DESC;

-- Example 3: Analyze breach trends
-- SELECT * FROM breach_trends_view WHERE organization_id = 'YOUR_ORG_ID' AND breaches_per_day > 1;
...
-- WHERE organization_id = 'YOUR_ORG_ID' AND health_status != 'Healthy';
