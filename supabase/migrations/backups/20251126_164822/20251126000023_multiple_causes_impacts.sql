...
-- SELECT * FROM risk_decomposition_view WHERE organization_id = 'YOUR_ORG_ID' LIMIT 10;

-- Example 3: Find complex risks (multiple causes/impacts)
-- SELECT * FROM complex_risks_view WHERE organization_id = 'YOUR_ORG_ID';

-- Example 4: Analyze root cause usage
-- SELECT * FROM root_cause_contribution_view WHERE organization_id = 'YOUR_ORG_ID' ORDER BY risk_count DESC;
