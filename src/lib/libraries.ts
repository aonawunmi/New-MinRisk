 ...
 *
 * Handles fetching from global and org-specific libraries.
 * All views automatically combine global + org data via UNION ALL.
 */
 ...
 */
export async function getRootCauses(): Promise<{ data: RootCause[] | null; error: Error | null }> {
  try {
 ...
 */
export async function getImpacts(): Promise<{ data: Impact[] | null; error: Error | null }> {
  try {
    const { data, error } = await supabase
 ...
 */
export async function getControls(): Promise<{ data: Control[] | null; error: Error | null }> {
  try {
    const { data, error } = await supabase
 ...
 */
export async function getKRIsAndKCIs(): Promise<{ data: KRIorKCI[] | null; error: Error | null }> {
  try {
    const { data, error } = await supabase
 ...
 */
export async function getRootCauseById(
  id: string
 ...
 */
export async function getImpactById(
  id: string
 ...
 */
export async function createCustomRootCause(
  data: {
    cause_code: string;
    cause_name: string;
  ...
  try {
    ...
    return { data: newCause as RootCause, error: null };
  } catch (err) {
 ...
 */
export async function createCustomImpact(
  data: {
    impact_code: string;
    impact_name: string;
  ...
  try {
    ...
    return { data: newImpact as Impact, error: null };
  } catch (err) {
